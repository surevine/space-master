...
PATCH_FILE=./2.12.9_patch_share.sh
...
# This script only patches share.war, not alfresco.war, and is adapted from patch_alfresco.sh
...
echo "    Adding to share..."
cp -f ${VERSION_HTML_FILE} ${ALFRESCO_HOME}/tomcat/webapps/share >$OUT_DEST
